<?php
// src/ESCPProjectBundle/Entity/SubmitFile
namespace ESCP\ProjectBundle\Entity;
use Doctrine\ORM\Mapping as ORM;
use Symfony\Component\HttpFoundation\File\UploadedFile;
use Symfony\Component\Validator\Constraints as Assert;

/**
 * @ORM\Table(name="escp_project_submit_file")
 * @ORM\Entity
...
class SubmitFile
{
  ...
  /**
   * @ORM\OneToOne(targetEntity="ESCP\ProjectBundle\Entity\SubmitStep", inversedBy="submitFile")
...
* @Assert\File(
  ...
  public function setFile(UploadedFile $file)
  {
     ...
     * Set submitStep
     *
     * @param \ESCP\ProjectBundle\Entity\SubmitStep $submitStep
     *
     * @return SubmitFile
     */
    public function setSubmitStep(\ESCP\ProjectBundle\Entity\SubmitStep $submitStep)
    {
     ...
     * Get submitStep
     *
     * @return \ESCP\ProjectBundle\Entity\SubmitStep
     */
    public function getSubmitStep()
    {
